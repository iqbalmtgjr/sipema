...
class SessionGuard implements StatefulGuard, SupportsBasicAuth
{
     ...
     */
    public function basic($field = 'email_akun_siswa', $extraConditions = [])
    {
        if ($this->check()) {
            return;
        }
     ...
     * @throws \Symfony\Component\HttpKernel\Exception\UnauthorizedHttpException
     */
    public function onceBasic($field = 'email_akun_siswa', $extraConditions = [])
    {
    ...
    {
        return [$field => $request->getUser(), 'kunci_akun_siswa' => $request->getPassword()];
    }
     ...
     */
    public function logoutOtherDevices($password, $attribute = 'kunci_akun_siswa')
    {
        if (!$this->user()) {
            return;
        }
